...
for seed in SEED:
  ...
  if args.method == 'GARM':
      gears_model = GEARS_GAR_M_v2(pert_data, device = 'cuda:0', 
  ...
  for epoch in range(epochs):
    ...
    if best_flag:
        ...
        fname = 'predictions/'+pert_data.dataset_name+'_'+args.method+'_v2_seed='+str(seed)+'_lr='+str(lr)+'_decay='+str(decay)+'_hidden='+str(args.hidden_size)+'.npz'
