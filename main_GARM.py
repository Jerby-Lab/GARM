...
parser.add_argument('--decay', default=1e-8, type=float, help='weight decay for training the model')
...
reduced_gene2feat = pickle.load(open('data/gene2GO_feature_D=256.pkl','rb'))
reduced_GenePT = None
  ...
  for epoch in range(epochs):
    ...
    if (epoch+1) % 10 == 0:
      ...
      if best_flag:
          ...
          fname = 'predictions/'+pert_data.dataset_name+'_GARM_seed='+str(seed)+'_lr='+str(lr)+'_decay='+str(decay)+'_K='+str(args.K)+'_BS='+str(args.batch_size)+'.npz'
